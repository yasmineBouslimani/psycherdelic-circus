...
class CommentController extends AbstractController
{
     ...
     */
    public function index(CommentRepository $commentRepository, ProgramRepository $programRepository): Response
    {
        return $this->render('comment/index.html.twig', [
            'comments' => $commentRepository->findCommentsByRate(),
    ...
    /**
     * @Route("/admin/comment/{id}", name="comment_delete", methods={"DELETE"})
     */
